...
class RoundRobinZipDatasets(FairseqDataset):
    ...
    def num_tokens_vec(self, indices):
        ...
        for key in self.datasets:
            ...
            map_indices = self._ordered_indices[key][indices % len(self._ordered_indices[key])]
    ...
    def filter_indices_by_size(self, indices, max_positions=None):
        ...
        def _deep_until_language_pair(dataset):
            from fairseq.data.image.raw_image_dataset import Image2TextDataset
            if isinstance(dataset, LanguagePairDataset) or isinstance(dataset, Image2TextDataset):
                return dataset
